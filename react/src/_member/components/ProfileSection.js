...
const ProfileSection = ({ title="{{section_title}}", member, attributes=false}) => {
    ...
    //#endregion
    //#region COMPONENTS
    const CardTitle = <Typography variant='h6'  component="div" color="textPrimary" fontWeight="600">{title}</Typography>;

    const AttributeItem = ({name, value}) => <Typography variant='p'  component="div" color="textPrimary">
        <Box>
    ...
    const EmailItem = ({email, title}, index) => <Typography variant='p'  component="div" color="textPrimary">
    ...
    const PhoneItem = ({phone, title}, index) => <Typography variant='p'  component="div" color="textPrimary">
    ...
    const SocialItem = ({type, value, link, title}, index) => <Typography variant='p'  component="div" color="textPrimary">
    ...
    const AttributeArea = <Stack direction={"column"} gap={2}>
