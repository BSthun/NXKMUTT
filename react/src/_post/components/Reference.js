...
import { alpha, Card, CardContent, Chip, Grid, Stack, Typography } from "@mui/material";
...
const LinkLists = () => <Stack direction="column" gap={2} mt={2}>
{links.map((link,idx) => <Box key={link.id}>•<Typography 
    component="a"
    target="_blank"
    href={link.link}
    title={link.link}
