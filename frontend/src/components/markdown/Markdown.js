...
const Markdown = ({children}, ...props) => {
    ...
    return <ReactMarkdown {...props} components={{
        ...
        u: ({node, ...props}) => <Typography variant='body1' {...props} sx={{
        ...
        blockquote: ({node, ...props}) => <Typography variant='body1' {...props} component="blockquote" sx={{
            borderLeft: `4px solid ${ alpha(theme.palette.text.primary, 0.3) }`,
            padding: '.5rem',
            background: alpha(theme.palette.text.primary,0.1),
        }} />,
    }}>
