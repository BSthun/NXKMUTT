...
const FilterBar = () => {
	...
	useEffect(() => {
		strapiAxios
			...
			.then((response) => {
				setTags({
					types: response.data.data.filter(
						(el) => el.attributes.category === 'type'
					),
					techniques: response.data.data.filter(
						(el) => el.attributes.category === 'technique'
					),
					theme: response.data.data.filter(
						(el) => el.attributes.category === 'theme'
					),
				})
			})
			.catch((error) => {
